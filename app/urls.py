...
urlpatterns = [
    ...
    path("category/<slug:val>",views.CategoryView.as_view(),
    name="category"),
    ...
    (template_name='app/password_reset.html', form_class=MyPasswordChangeForm),
    name='password_reset'),
    ...
    path('password-reset/done', auth_view.PasswordResetView.as_view(template_name='app/password_reset.html',
